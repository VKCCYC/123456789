<template lang="pug">
v-carousel.bg-color(hide-delimiters height="100vh" cycle interval= 3000 )
  v-carousel-item(v-for='(item,i) in items', :key='i', :src='item.src' )

v-container

  v-banner(bg-color="#28231F" color="#403635" icon='mdi-newspaper-variant-outline' border="none")
    template(v-slot:prepend)
      v-avatar
    v-banner-text 2024/03 活動公告 ~~~ 儲值 20000 送 2000
